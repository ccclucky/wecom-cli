...
class GeneratedWeComClient:
    ...
    def advanced_feature_set_approval_detail(self, *, apply_id: str, approval_id: str, approval_status: str, approval_url: str, process_list_node_list: str, process_list_node_list_node_apv_status: str, process_list_node_list_node_apv_rel: str, process_list_node_list_current_approvers: str | None = None, process_list_node_list_completed_approvers: str | None = None, process_list_node_list_apv_update_time: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def appchat_update(self, *, chatid: str, name: str | None = None, owner: str | None = None, add_user_list: str | None = None, del_user_list: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def chatdata_sync_call_program(self, *, program_id: str, ability_id: str, notify_id: str | None = None, request_data: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def checkin_add_checkin_record(self, *, records: str, userid: str, checkin_time: str, location_title: str, location_detail: str, notes: str | None = None, wifiname: str | None = None, wifimac: str | None = None, mediaids: str | None = None, lat: str | None = None, lng: str | None = None, device_type: str, device_detail: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def checkin_punch_correction(self, *, userid: str, schedule_date_time: str, schedule_checkin_time: str | None = None, checkin_time: str, remark: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def corpgroup_corp_list_app_share_info(self, *, business_type: str | None = None, agentid: str, corpid: str | None = None, limit: str | None = None, cursor: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def corpgroup_corp_remove_corp(self, *, chain_id: str, corpid: str | None = None, pending_corpid: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def corpgroup_import_chain_contact(self, *, chain_id: str, contact_list: str, contact_list_corp_name: str, contact_list_group_path: str | None = None, contact_list_custom_id: str | None = None, contact_list_contact_info_list: str, contact_list_contact_info_list_name: str, contact_list_contact_info_list_identity_type: str, contact_list_contact_info_list_mobile: str, contact_list_contact_info_list_user_custom_id: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def corpgroup_unionid_to_external_userid(self, *, unionid: str, openid: str, corpid: str | None = None, mass_call_ticket: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
            ...
            json_body={
                ...
                'openid': openid,
                'corpid': corpid,
                'mass_call_ticket': mass_call_ticket
                },
        )

    def customers_add_contact_way(self, *, type: str, scene: str, style: str | None = None, remark: str | None = None, skip_verify: bool | None = None, state: str | None = None, user: str | None = None, party: str | None = None, is_temp: bool | None = None, expires_in: str | None = None, chat_expires_in: str | None = None, unionid: str | None = None, is_exclusive: bool | None = None, mark_source: bool | None = None, conclusions: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_batch_get_by_user(self, *, userid_list: str, cursor: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_get_strategy_tag_list(self, *, strategy_id: str | None = None, tag_id: str | None = None, group_id: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_groupchat_list(self, *, status_filter: str | None = None, owner_filter: str | None = None, owner_filter_userid_list: str | None = None, cursor: str | None = None, limit: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_mark_tag(self, *, userid: str, external_userid: str, add_tag: str | None = None, remove_tag: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_message_send(self, *, recv_scope: int | None = None, to_parent_userid: Any | None = None, to_student_userid: Any | None = None, to_party: Any | None = None, toall: int | None = None, msgtype: str | None = None, agentid: int | None = None, text: Any | None = None, enable_id_trans: int | None = None, enable_duplicate_check: int | None = None, duplicate_check_interval: int | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_remark(self, *, userid: str, external_userid: str, remark: str | None = None, description: str | None = None, remark_company: str | None = None, remark_mobiles: str | None = None, remark_pic_mediaid: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_resigned_transfer_customer(self, *, handover_userid: str, takeover_userid: str, external_userid: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_send_welcome_msg(self, *, welcome_code: str, text_content: str | None = None, attachments: str | None = None, attachments_msgtype: str, image_media_id: str | None = None, image_pic_url: str | None = None, link_title: str, link_picurl: str | None = None, link_desc: str | None = None, link_url: str, miniprogram_title: str, miniprogram_pic_media_id: str, miniprogram_appid: str, miniprogram_page: str, video_media_id: str, file_media_id: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def customers_transfer_customer(self, *, handover_userid: str, takeover_userid: str, external_userid: str, transfer_success_msg: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def dial_get_dial_record(self, *, start_time: str | None = None, end_time: str | None = None, offset: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def exmail_app_compose_send(self, *, to: str, to_emails: str | None = None, to_userids: str | None = None, cc: str | None = None, cc_emails: str | None = None, cc_userids: str | None = None, bcc: str | None = None, bcc_emails: str | None = None, bcc_userids: str | None = None, subject: str, content: str, attachment_list: str | None = None, attachment_list_file_name: str, attachment_list_content: str, content_type: str | None = None, schedule: str, schedule_schedule_id: str | None = None, schedule_method: str | None = None, schedule_location: str | None = None, schedule_start_time: int, schedule_end_time: int, schedule_reminders: str | None = None, schedule_reminders_is_remind: bool | None = None, schedule_reminders_remind_before_event_mins: int | None = None, schedule_reminders_timezone: int | None = None, schedule_reminders_is_repeat: bool | None = None, schedule_reminders_is_custom_repeat: bool | None = None, schedule_reminders_repeat_type: int | None = None, schedule_reminders_repeat_interval: int | None = None, schedule_reminders_repeat_day_of_week: str | None = None, schedule_reminders_repeat_day_of_month: str | None = None, schedule_reminders_repeat_month_of_year: str | None = None, schedule_reminders_repeat_until: int | None = None, meeting: str | None = None, meeting_hosts: str | None = None, meeting_meeting_admins: str, meeting_option: str | None = None, meeting_option_password: str | None = None, meeting_option_auto_record: bool | None = None, meeting_option_enable_waiting_room: bool | None = None, meeting_option_allow_enter_before_host: bool | None = None, meeting_option_enter_restraint: bool | None = None, meeting_option_enable_screen_watermark: bool | None = None, meeting_option_enable_enter_mute: bool | None = None, meeting_option_remind_scope: bool | None = None, meeting_option_water_mark_type: int | None = None, enable_id_trans: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def exmail_group_create(self, *, groupid: str, groupname: str, email_list: str | None = None, tag_list: str | None = None, department_list: str | None = None, group_list: str | None = None, allow_type: str | None = None, allow_emaillist: str | None = None, allow_departmentlist: str | None = None, allow_taglist: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def exmail_group_update(self, *, groupid: str, groupname: str | None = None, email_list: str | None = None, tag_list: str | None = None, department_list: str | None = None, group_list: str | None = None, allow_type: str | None = None, allow_emaillist: str | None = None, allow_departmentlist: str | None = None, allow_taglist: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def externalpay_get_bill_list(self, *, begin_time: str, end_time: str, payee_userid: str | None = None, cursor: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def externalpay_get_fund_flow(self, *, begin_time: str, end_time: str, mch_id: str | None = None, cursor: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def hardware_get_hardware_checkin_data(self, *, filter_type: str | None = None, starttime: str, endtime: str, useridlist: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def health_get_report_answer(self, *, jobid: str, date: str, offset: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def hr_get_staff_info(self, *, userid: str, get_all: bool | None = None, fieldids: str | None = None, fieldids_fieldid: str, fieldids_sub_idx: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def hr_update_staff_info(self, *, userid: str, update_items: str | None = None, remove_items: str | None = None, insert_items: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def kf_get_servicer_statistic(self, *, open_kfid: str, servicer_userid: str | None = None, start_time: str, end_time: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def kf_knowledge_add_intent(self, *, group_id: str, question: str, question_text: str, question_text_content: str, similar_questions: str | None = None, similar_questions_items: str | None = None, similar_questions_items_text: str, similar_questions_items_text_content: str, answers: str, answers_text: str, answers_text_content: str, answers_attachments: str | None = None, answers_attachments_1: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def kf_send_msg(self, *, touser: str | None = None, open_kfid: str | None = None, msgid: str | None = None, msgtype: str | None = None, text: Any | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_create(self, *, admin_userid: str, title: str, meeting_start: str, meeting_duration: str, description: str | None = None, location: str | None = None, agentid: str | None = None, invitees: str | None = None, invitees_userid: str | None = None, cal_id: str | None = None, settings: str | None = None, reminders: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_enroll_set_config(self, *, meetingid: str, approve_type: str | None = None, is_collect_question: bool | None = None, question_list: str | None = None, no_registration_needed_for_staff: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_get_user_meetingid(self, *, userid: str, cursor: str | None = None, limit: str | None = None, begin_time: str | None = None, end_time: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_layout_add_background(self, *, meetingid: str, image_list: str, default_image_order: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
            ...
            json_body={
                ...
                'default_image_order': default_image_order
                },
        )
    ...
    def meeting_layout_batch_delete_background(self, *, meetingid: str, background_id_list: str) -> dict:
        return self._requester.request(
            ...
            json_body={
                'meetingid': meetingid,
                'background_id_list': background_id_list
                },
        )
    ...
    def meeting_mra_set_default_layout(self, *, meetingid: str, default_layout: str, default_novideo_user: str, mra_tmp_openid: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_poll_create_theme(self, *, operator_userid: str, instance_id: int, meetingid: str, poll_topic: str, poll_desc: str, is_anony: bool | None = None, poll_questions: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_poll_delete(self, *, operator_userid: str, instance_id: int, meetingid: str, poll_theme_id: str | None = None, poll_id: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_poll_finish(self, *, operator_userid: str, instance_id: int, meetingid: str, poll_theme_id: str, poll_id: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_poll_update_theme(self, *, operator_userid: str, instance_id: int, meetingid: str, poll_theme_id: str, poll_topic: str, poll_desc: str, is_anony: bool | None = None, poll_questions: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_realcontrol_dismiss(self, *, meetingid: str, force_dismiss: bool | None = None, retrieve_code: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
            endpoint='/cgi-bin/meeting/realcontrol/dismiss',
            json_body={
                'meetingid': meetingid,
                'force_dismiss': force_dismiss,
    ...
    def meeting_record_update_sharing_config(self, *, meeting_record_id: str, meetingid: str, sharing_config: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_statistics_get_start_list(self, *, type: int, begin_time: int, end_time: int, limit: int | None = None, cursor: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_update(self, *, meetingid: str, title: str | None = None, meeting_start: str | None = None, meeting_duration: str | None = None, description: str | None = None, location: str | None = None, remind_time: str | None = None, agentid: str | None = None, invitees: str | None = None, invitees_userid: str | None = None, cal_id: str | None = None, settings: str | None = None, reminders: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_waitingroom_get_current_user_list(self, *, meetingid: str, limit: str | None = None, cursor: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_webinar_create(self, *, admin_userid: str, title: str, sponsor: str | None = None, start_time: str, end_time: str, admission_type: str, hosts: str | None = None, password: str | None = None, cover_url: str | None = None, description: str | None = None, enable_guest_invite_link: bool | None = None, media_setting: str | None = None, enable_qa: bool | None = None, sensitive_words: str | None = None, enable_manual_check: bool | None = None, activity_page: bool | None = None, display_number_of_attendees: str | None = None, playback_for_audience: bool, preparation_mode: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def meeting_webinar_update(self, *, meetingid: str, title: str, sponsor: str | None = None, start_time: str, end_time: str, admission_type: str, hosts: str | None = None, password: str | None = None, cover_url: str | None = None, description: str | None = None, enable_guest_invite_link: bool | None = None, media_setting: str | None = None, enable_qa: bool | None = None, sensitive_words: str | None = None, enable_manual_check: bool | None = None, activity_page: bool | None = None, display_number_of_attendees: str | None = None, playback_for_audience: bool, preparation_mode: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def messages_send_text(self, *, to_user: str, agent_id: int, content: str, touser: str | None = None, toparty: str | None = None, totag: str | None = None, msgtype: str | None = None, agentid: int | None = None, text: Any | None = None, safe: int | None = None, enable_id_trans: int | None = None, enable_duplicate_check: int | None = None, duplicate_check_interval: int | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def miniapppay_create_order(self, *, 应用ID: str, 商户号: str, 商户订单号: str, 商品描述: str, 下单场景key: str | None = None, 订单总金额: int, 货币类型: str, 支付者标识: str, 交易结束时间: str | None = None, 附加数据: str | None = None, 订单优惠标记: str | None = None, 订单原价: int | None = None, 商品小票ID: str | None = None, 商户侧商品编码: str, 微信支付商品编码: str | None = None, 商品名称: str | None = None, 商品数量: int, 商品单价: int, 用户终端IP: str, 商户端设备号: str | None = None, 门店编号: str, 门店名称: str | None = None, 地区编码: str | None = None, 详细地址: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def miniapppay_get_sign(self, *, 应用ID: str, 预支付交易会话标识: str, 签名方式: str | None = None, 随机字符串: str, 时间戳: int) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def miniapppay_refund(self, *, 商户号: str, 商户APPID: str, 商户订单号: str, 商户退款单号: str, 退款原因: str | None = None, 订单金额: str, 资金账户: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def msgaudit_get_robot_info(self, *, msgid: str | None = None, action: str | None = None, from_: str | None = None, tolist: str | None = None, roomid: str | None = None, msgtime: str | None = None, msgtype: str | None = None, content: str | None = None) -> dict:
        return self._requester.request(
            method='GET',
    ...
    def oa_applyevent(self, *, creator_userid: str, template_id: str, use_template_approver: str, choose_department: str | None = None, apply_data: str, contents: str, control: str, id: str, value: str, summary_list: str, summary_info: str, text: str, lang: str, process: str | None = None, node_list: str, type: str, apv_rel: str | None = None, userid: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_approval_create_template(self, *, template_name: str, text: str, lang: str, template_content: str, controls: str, property: str, control: str, id: str, title: str, text_1: str, lang_1: str, placeholder: str | None = None, text_2: str | None = None, lang_2: str | None = None, require: bool | None = None, un_print: bool | None = None, config: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_approval_update_template(self, *, template_id: str, template_name: str, text: str, lang: str, template_content: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_calendar_update(self, *, skip_public_range: bool | None = None, calendar: str, cal_id: str, admins: str | None = None, summary: str, color: str, description: str | None = None, public_range: str | None = None, public_range_userids: str | None = None, public_range_partyids: str | None = None, shares: str | None = None, shares_userid: str, shares_permission: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_meetingroom_add(self, *, name: str, capacity: str, city: str | None = None, building: str | None = None, floor: str | None = None, equipment: str | None = None, coordinate_latitude: str | None = None, coordinate_longitude: str | None = None, range_user_list: str | None = None, range_department_list: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_meetingroom_get_booking_info(self, *, meetingroom_id: str | None = None, start_time: str | None = None, end_time: str | None = None, city: str | None = None, building: str | None = None, floor: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_schedule_add_attendees(self, *, schedule_id: str, attendees: str | None = None, attendees_userid: str) -> dict:
        return self._requester.request(
            method='POST',
            ...
            json_body={
                ...
                'attendees': attendees,
                'attendees_userid': attendees_userid
                },
        )

    def oa_schedule_del(self, *, schedule_id: str, op_mode: str | None = None, op_start_time: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_schedule_del_attendees(self, *, schedule_id: str, attendees: str | None = None, attendees_userid: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def oa_schedule_update(self, *, skip_attendees: bool | None = None, op_mode: str | None = None, op_start_time: str | None = None, schedule: str, schedule_schedule_id: str, schedule_admins: str | None = None, schedule_attendees: str | None = None, schedule_attendees_userid: str, schedule_summary: str | None = None, schedule_description: str | None = None, schedule_reminders: str | None = None, schedule_reminders_is_remind: bool | None = None, schedule_reminders_is_repeat: bool | None = None, schedule_reminders_remind_before_event_secs: str | None = None, schedule_reminders_remind_time_diffs: str | None = None, schedule_reminders_repeat_type: str | None = None, schedule_reminders_repeat_until: str | None = None, schedule_reminders_is_custom_repeat: bool | None = None, schedule_reminders_repeat_interval: str | None = None, schedule_reminders_repeat_day_of_week: str | None = None, schedule_reminders_repeat_day_of_month: str | None = None, schedule_reminders_timezone: str | None = None, schedule_location: str | None = None, schedule_start_time: str, schedule_end_time: str, schedule_is_whole_day: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_department_create(self, *, name: str | None = None, parentid: str, id: str | None = None, type: str, standard_grade: str | None = None, register_year: str | None = None, order: str | None = None, department_admins: str | None = None, department_admins_userid: str, department_admins_type: str, department_admins_subject: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_department_update(self, *, name: str | None = None, parentid: str | None = None, id: str, new_id: str | None = None, register_year: str | None = None, standard_grade: str | None = None, order: str | None = None, department_admins: str | None = None, department_admins_op: str, department_admins_userid: str, department_admins_type: str | None = None, department_admins_subject: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_batch_create_parent(self, *, parents: str, parents_parent_userid: str, parents_mobile: str, parents_to_invite: bool | None = None, parents_children: str, parents_children_student_userid: str, parents_children_relation: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_batch_create_student(self, *, students: str, students_student_userid: str, students_mobile: str | None = None, students_to_invite: bool | None = None, students_name: str, students_department: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_batch_update_parent(self, *, parents: str | None = None, parents_parent_userid: str, parents_new_parent_userid: str | None = None, parents_mobile: str | None = None, parents_children: str | None = None, parents_children_student_userid: str, parents_children_relation: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_batch_update_student(self, *, students: str | None = None, students_student_userid: str, students_mobile: str | None = None, students_new_student_userid: str | None = None, students_name: str | None = None, students_department: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_create_parent(self, *, parent_userid: str, mobile: str, to_invite: bool | None = None, children: str, children_student_userid: str, children_relation: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_create_student(self, *, student_userid: str, mobile: str | None = None, to_invite: bool | None = None, name: str, department: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_update_parent(self, *, parent_userid: str, new_parent_userid: str | None = None, mobile: str | None = None, children: str | None = None, children_student_userid: str, children_relation: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def school_user_update_student(self, *, student_userid: str, mobile: str | None = None, new_student_userid: str | None = None, name: str | None = None, department: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def security_get_screen_oper_record(self, *, start_time: int, end_time: int, userid_list: str | None = None, department_id_list: str | None = None, screen_shot_type: int | None = None, cursor: str | None = None, limit: int | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def security_trustdevice_import(self, *, device_list_system: str, device_list_mac_addr: str, device_list_motherboard_uuid: str | None = None, device_list_harddisk_uuid: str | None = None, device_list_domain: str | None = None, device_list_pc_name: str | None = None, device_list_seq_no: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_get_form_statistic(self, *, repeated_id: str, req_type: str, start_time: str | None = None, end_time: str | None = None, limit: str | None = None, cursor: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_mod_doc_safty_setting(self, *, docid: str, enable_readonly_copy: bool | None = None, watermark: str | None = None, margin_type: str | None = None, show_visitor_name: bool | None = None, show_text: bool | None = None, text: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_modify_form(self, *, oper: str, formid: str, form_title: str | None = None, form_desc: str | None = None, form_header: str | None = None, form_question: str | None = None, items: str, question_id: str, title: str, pos: str, status: str, reply_type: str, must_reply: bool, note: str | None = None, placeholder: str | None = None, question_extend_setting: str | None = None, option_item: str, key: str, value: str, status_1: str, form_setting: str | None = None, fill_out_auth: str, fill_in_range: str | None = None, userids: str | None = None, departmentids: str | None = None, setting_manager_range: str | None = None, timed_repeat_info: str | None = None, timed_repeat_info_enable: bool | None = None, timed_repeat_info_remind_time: str | None = None, timed_repeat_info_repeat_type: str | None = None, timed_repeat_info_week_flag: str | None = None, timed_repeat_info_skip_holiday: bool | None = None, timed_repeat_info_day_of_month: str | None = None, timed_repeat_info_fork_finish_type: bool | None = None, allow_multi_fill: bool | None = None, timed_finish: str | None = None, can_anonymous: bool | None = None, can_notify_submit: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_add_field_group(self, *, docid: str, sheet_id: str, name: str, children: str | None = None, children_field_id: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_add_records(self, *, docid: str, sheet_id: str, key_type: str | None = None, records: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_add_sheet(self, *, docid: str, properties: str | None = None, properties_title: str | None = None, properties_index: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_add_view(self, *, docid: str, sheet_id: str, view_title: str, view_type: str, property_gantt: str | None = None, property_calendar: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_content_priv_get_sheet_priv(self, *, docid: str, type: str, rule_id_list: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_get_field_groups(self, *, docid: str, sheet_id: str, offset: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_get_fields(self, *, docid: str, sheet_id: str, view_id: str | None = None, field_ids: str | None = None, field_titles: str | None = None, offset: int | None = None, limit: int | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_get_records(self, *, docid: str, sheet_id: str, view_id: str | None = None, record_ids: str | None = None, key_type: str | None = None, field_titles: str | None = None, field_ids: str | None = None, sort: str | None = None, offset: str | None = None, limit: str | None = None, ver: str | None = None, filter_spec: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_get_sheet(self, *, docid: str, sheet_id: str | None = None, need_all_type_sheet: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_get_views(self, *, docid: str, sheet_id: str, view_ids: str | None = None, offset: str | None = None, limit: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_update_field_group(self, *, docid: str, sheet_id: str, field_group_id: str, name: str | None = None, children: str | None = None, children_field_id: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_update_records(self, *, docid: str, sheet_id: str, key_type: str | None = None, records: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_update_sheet(self, *, docid: str, properties_sheet_id: str, properties_title: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedoc_smartsheet_update_view(self, *, docid: str, sheet_id: str, view_id: str, view_title: str | None = None, property: str | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedrive_file_acl_del(self, *, fileid: str, auth_info: str, type_后续将废弃: str, userid: str, departmentid_后续将废弃: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedrive_file_secure_setting(self, *, fileid: str, text: str | None = None, margin_type: str | None = None, show_visitor_name: bool | None = None, show_text: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedrive_file_upload(self, *, spaceid: str | None = None, fatherid: str | None = None, selected_ticket: str | None = None, file_name: str, file_base64_content: str) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedrive_file_upload_init(self, *, spaceid: str | None = None, fatherid: str | None = None, selected_ticket: str | None = None, file_name: str, size: str, block_sha: str, skip_push_card: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
    ...
    def wedrive_space_setting(self, *, spaceid: str, enable_watermark: bool | None = None, enable_confidential_mode: bool | None = None, share_url_no_approve: bool | None = None, share_url_no_approve_default_auth: str | None = None, default_file_scope: str | None = None, ban_share_external: bool | None = None) -> dict:
        return self._requester.request(
            method='POST',
